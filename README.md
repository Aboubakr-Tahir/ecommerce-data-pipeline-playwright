# **📸 E-Commerce Data Pipeline with Playwright & MongoDB**
...
bh_scraper_project/  
│  
├── data/ \# Stores your "VIP Pass" (Cookies)  #please when pulling the repo create this folder before running the 1_get_acces.py script
│ └── auth.json \# (Generated by Script 1\)  
│  
├── docker/ \# Database Infrastructure  
│ └── docker-compose.yml \# MongoDB \+ Mongo Express UI  
│  
├── scripts/ \# Python Logic  
│ ├── 1_get_access.py \# The "Key Maker" (Run manually)  
│ └── 2_scrape_data.py \# The "Robot" (Run automatically)  
│  
